...
Long-only: negative signals are clamped to zero.

When A-share outperforms H-share:
  - Spread rises, z-score positive
  - A-share signal would be negative → clamped to 0 (no position)
  - H-share signal is positive → long H

When A-share underperforms H-share:
  - Spread falls, z-score negative
  - A-share signal is positive → long A
  - H-share signal would be negative → clamped to 0 (no position)
