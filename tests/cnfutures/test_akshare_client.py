...
class TestGetContractList:
    ...
    def test_contains_known_exchanges(self, client):
        df = client.get_contract_list()
        assert df is not None
...
class TestGetContractDetail:
    ...
    def test_returns_key_value_dataframe(self, client):
...
class TestGetDailyData:
    ...
    def test_specific_contract_returns_data(self, client):
